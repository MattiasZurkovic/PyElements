...
def get_info_by_name(elem_name):
	return parsed_data[elem_name.upper()]

def get_info_by_atomic_number(atomic_number):
	element_ans = element_names[atomic_number - 1]
	return parsed_data[element_ans.upper()]

print get_info_by_name("Thorium")
print get_info_by_atomic_number(4)
print parsed_data['HYDROGEN']
